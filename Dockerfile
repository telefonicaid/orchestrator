...
ENV ORCHESTRATOR_VERSION 4.12.0
ENV python_lib /var/env-orchestrator/lib/python3.13/site-packages
...
RUN \
    useradd -u ${ORCHESTRATOR_USER_UID} -m ${ORCHESTRATOR_USER} && \
