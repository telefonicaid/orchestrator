...
def main():
    ...
    print "This script creates a new service group in IoT keystone"
    print ""
    ...
    if (len(sys.argv) - 1 < NUM_ARGS_EXPECTED):
        ...
        print "  <NEW_GROUP_NAME>                Name of new group"
        print ""
        print "  Typical usage:"
    ...
    validate(
        {
            ...
            "NEW_SERVICE_GROUP_NAME": NEW_GROUP_NAME,
        },
    ...
    res, service_name, subservice_name = flow.createNewServiceGroup(
        SERVICE_NAME,
        None,
        SERVICE_ADMIN_USER,
