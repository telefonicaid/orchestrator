...
def main():
    ...
    print "This script revoke a role to a service group IoT keystone"
    print ""
    ...
    if (len(sys.argv) - 1 < NUM_ARGS_EXPECTED):
        ...
        print "  <SERVICE_GROUP_NAME>            Service group name"
    ...
    flow.revokeInheritRoleServiceGroup(
        SERVICE_NAME,
        None,
        SERVICE_ADMIN_USER,
