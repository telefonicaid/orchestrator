...
urlpatterns = patterns('',
     ...
     url(r'^service/(?P<service_id>\w+)/module_activation[/]?$', SubServiceModuleActivation_RESTView.as_view(), name='servicemodule_rest_view'),
     ...
     url(r'^service/(?P<service_id>\w+)/subservice/(?P<subservice_id>\w+)/module_activation[/]?$', SubServiceModuleActivation_RESTView.as_view(), name='subservicemodule_rest_view'),
