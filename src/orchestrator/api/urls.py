...
urlpatterns = [
     ...
     url(r'^service/(?P<service_id>\w+)/group_role_assignments[/]?$', AssignRoleGroup_RESTView.as_view(), name='assign_group_role_rest_view'),
     ...
     url(r'^ldap/group?$', LdapGroup_RESTView.as_view(), name='ldap_group_rest_view'),
